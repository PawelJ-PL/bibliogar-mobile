...
export const registerDeviceAction = actionCreator.async<{uniqueId: string, deviceDescription: DeviceDescription, csrfToken: string}, string, Error>("REGISTER_DEVICE");
