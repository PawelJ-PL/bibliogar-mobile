...
export type ModifyLoanInitialData =
    Omit<EditLoanReq, 'libraryId' | 'books'>
    & { libraryId: string | null, books: Array<Book | null> }
...
const EditLoanForm: React.FC<Props> = ({availableLibraries, onSubmit, submitError, processingSubmit, initialData}) => {
        ...
        <ScrollView showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false}>
            ...
            <Card>
                <View style={styles.sectionContainer}>
                    ...
                    >
                        {availableLibraries.map(lib => <Picker.Item label={lib.name} value={lib.id} key={lib.id}/>)}
                    </Picker>
                    <Divider/>
                </View>
